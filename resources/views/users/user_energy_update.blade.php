            ...
            <div class="column ">
                <div class="card">
                    ...
                    <div class="card-block">
                        <form action="{{route('energy_indication_save', $data->id)}}" method="post"
                              style="display: flex; flex-direction: column" class="forms" enctype="multipart/form-data">
                            @csrf()
                            <input type="text" class='req' name='value' value="{{$data->value}}" placeholder="Энергия">
