      ...
      <div class="payment__wrapper">
        ...
        <div class="payment__block">
          <div class="payment__block-info payment-info">
            ...
            <div class="payment-info__text"><span class="payment-info__title">членские взносы</span>@include('inc.payment_mem')</div>
          </div>
          <div class="payment__block-info payment-info">
            <div class="payment-info__image payment-info__image_2"></div>
            <div class="payment-info__text"><span class="payment-info__title">целевые взносы</span>@include('inc.payment_ceil')</div>
          </div>
          <div class="payment__block-info payment-info">
            <div class="payment-info__image payment-info__image_3"></div>
            <div class="payment-info__text"><span class="payment-info__title">электроэнергия</span>@include('inc.payment_electricity')</div>
          </div>
        </div>
      </div>
    </section>
          ...
          <div class="address__info"><span id="auto">на автомобиле</span><span id="public-trans">на общественном транспорте</span>
            ...
            <div class="address__time">
              <div class="address__time-block">
                <div class="address__text"><span class="address__text-title">адрес:<br></span><span class="address__text-subtitle"> Тульская область, Ленинский район, д. Дементеево</span></div>
                <div class="address__text"><span class="address__text-title">часы приема:<br></span>@include('inc.work_time')</div>
              </div>
              <div class="address__time-block">
                <div class="address__text"><span class="address__text-title">тел:<br></span>@include('inc.telephone_bottom')</div>
                <div class="address__text"><span class="address__text-title">работа правления:<br></span>@include('inc.work_time')</div>
              </div>
            </div>
          </div>
