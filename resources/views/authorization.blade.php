    ...
    <section class="private-forms">
        ...
        <div class="private-forms__wrapper">
            <div class="private-forms__login login">
                ...
                <form action="{{route('check')}}" method="post" id="authorization" class="forms">
                    @csrf()
                    <input type="email" class='req auth_email' name='auth_email' placeholder="Введите Email">
                    <input type="password" class='req auth_password' name='auth_password' placeholder="Введите пароль">
                    <label class="checkbox-other">
                        <input type="checkbox" value="save" id="save-cookie">
